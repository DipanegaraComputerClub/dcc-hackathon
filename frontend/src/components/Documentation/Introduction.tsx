...
// ❌ Hapus import gambar dari public
// ✅ Perbaiki import Iconify (jangan pakai /dist/...)
...
export const Introduction = () => {
    ...
    // ✅ Gunakan path string langsung (tanpa '/public')
                        ...
                        PackageVersions && PackageVersions.map((item) => {
                            return (
                                <div key={item.id} className="lg:w-1/5 md:w-full text-center lg:border-b-0 border-b lg:border-e lg:last:border-e-0 last:border-b-0 border-border dark:border-dark_border">
                                    {/* ✅ Tambahkan width & height karena src berupa string */}
                                    <Image 
                                        src={item.img} 
                                        alt="npm-package" 
                                        width={40}
