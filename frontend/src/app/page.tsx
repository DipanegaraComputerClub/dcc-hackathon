      ...
      <nav className="relative z-10 w-full px-6 py-6 flex justify-between items-center max-w-7xl mx-auto animate-in fade-in slide-in-from-top-4 duration-1000">
        <div className="flex items-center gap-2 font-bold text-xl text-gray-900 dark:text-white group cursor-pointer">
          ...
          <span className="tracking-tight">
            {umkmProfile?.business_name || "TABE AI"}
          </span>
        </div>
        <div className="flex gap-3 md:gap-4">
          <Link href="/login">
            <Button
              variant="ghost"
              className="text-gray-600 dark:text-gray-300 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all hover:scale-105 active:scale-95"
            >
              Masuk
            </Button>
          </Link>
      ...
      <div className="container relative z-10 mx-auto px-4 py-16 lg:py-28">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight text-gray-900 dark:text-white leading-tight animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
            ...
            <span className="animate-shimmer">Gagah & Laris Manis!</span>
          </h1>
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
            Asisten AI asli anak Makassar, siap bantu ki' bikin konten, atur
            jualan, sampai layani pelanggan. Tidak pake ribet, gampang sekali mi
            dipakai!
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
            <Link href="/register">
              <Button
                size="lg"
                className="w-full sm:w-auto gap-2 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-8 py-6 rounded-xl shadow-xl shadow-red-500/30 text-lg font-bold transition-all hover:scale-105 active:scale-95 hover:shadow-red-500/50 group"
              >
                Gaskanmi Daftar
            ...
            {/* <Link href="#fitur">
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto gap-2 border-gray-300 dark:border-gray-700 px-8 py-6 rounded-xl text-lg hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-white bg-white/50 dark:bg-black/20 backdrop-blur-sm transition-all hover:scale-105 active:scale-95"
              >
                Lihat Fiturnya
              </Button>
            </Link> */}
      ...
      >
        {[
          ...
          },
          {
            ...
            badge: "24 Jam",
            image:
              "https://smartlegal.id/wp-content/uploads/bb-plugin/cache/Cara-Menemukan-Ide-Bisnis-dan-Peluang-Usaha-landscape-4cf9764419409a7731b7f4d40c05eb61-uy3m5qgd78np.webp",
          },
          {
          ...
          <div
            key={idx}
            className="snap-center min-w-[80%] sm:min-w-[45%] lg:min-w-[30%]"
          >
            <Card className="group border border-gray-200 dark:border-gray-800 bg-white/60 dark:bg-gray-900/60 backdrop-blur-md transition-all hover:shadow-2xl hover:-translate-y-2 duration-300 rounded-xl overflow-hidden">
              {/* GAMBAR URL */}
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex items-center justify-center">
            <img
              src="https://thumbs.dreamstime.com/b/beautiful-smiling-businesswoman-arms-folded-standing-black-suit-brown-jacket-isolated-white-background-also-105189427.jpg"
          ...
          {/* BAGIAN TEKS */}
          <div>
            <p className="text-red-600 font-semibold tracking-wider mb-2">
              KENAPA HARUS PILIH TABE AI?
            </p>

            <h2 className="text-4xl font-bold text-gray-900 leading-tight mb-4">
              Bikin Usaha Makin Gagah <br /> & Laris Manis!
            </h2>

            <p className="text-gray-600 mb-8">
              Dipakai ribuan pelaku UMKM tiap bulan — cepat, praktis, dan
              otomatis bantu ki' atur jualan sampai layani pelanggan.
            </p>

            {/* List */}
            <div className="space-y-6 mb-10">
              <div className="flex items-start gap-3">
                <div className="w-7 h-6 flex items-center justify-center bg-red-100 text-red-600 rounded-full text-sm font-bold">
                  ✓
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900">
                    Konten Cepat & Berkualitas
                  </h3>
                  <p className="text-gray-600 text-sm">
                    Tabe AI bantu ki' bikin caption, poster, dan ide konten yang
                    rapi, menarik, dan cocok sama gaya jualanta'.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">
                    Asisten AI Terlatih & Siap Pakai
                  </h3>
                  <p className="text-gray-600 text-sm">
                    Dibuat khusus untuk UMKM — kerja cepat, hasil presisi, dan
                    gampang sekali dipakai tanpa perlu pusing.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">
                    Pelayanan Ramah & Sigap
                  </h3>
                  <p className="text-gray-600 text-sm">
                    Ada kendala atau mau tanya-tanya? Tinggal bilang saja —
                    respons cepat, jelas, dan tidak pake ribet.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-[#020617] py-12 relative z-10">
        <div className="container mx-auto px-4 text-center">
          <div className="flex justify-center items-center gap-2 mb-4 font-bold text-2xl text-gray-900 dark:text-white group cursor-default">
            <Store className="h-6 w-6 text-red-600 group-hover:rotate-12 transition-transform duration-300" />{" "}
            TABE AI
          </div>
          <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-md mx-auto">
            Platform digital kebanggaan Makassar. Dibuat dengan ❤️ dan semangat
            Ewako untuk memajukan ekonomi lokal.
          </p>
          <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-400 mb-8">
            <Link
              href="#"
              className="hover:text-red-600 transition-colors hover:underline underline-offset-4"
            >
              Tentang Kami
            </Link>
            <Link
